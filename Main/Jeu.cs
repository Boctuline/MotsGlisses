        ...
        public Jeu(Plateau plateau, Joueur j1, Joueur j2, Dictionnaire dictionnaire, bool modePortail, int animation) {
            ...
            while (restant > new TimeSpan(0) && !plateau.Plateau_Vide())
            {
                ...
                do
                {
                    ...
                    else if(!dictionnaire.RechDichoRecursif(rep) && rep.ToLower() != "gilles nocture") { Titre(); plateau.Afficher(); Console.WriteLine(rep + " n'est pas un mot " + dictionnaire.Langue + " !\n" + jactuel.Nom + ", il vous reste " + restantTour.Minutes + " minutes et " + restantTour.Seconds + " secondes.\nEntrez un mot à nouveau."); repeat = true; }
        ...
        public static int DemandeTimer(int temps, bool type = false, int minutes = 59)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    else if (temps > minutes) { Console.WriteLine(type?"59 secondes maximum !": minutes + " minutes maximum !"); repeat = true; }
                    else if (temps < 0) { Console.WriteLine("Entrez un nombre positif"); repeat = true; }
                }
